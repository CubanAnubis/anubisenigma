...
ringSettings ="LOH"
ringPositions = "HPB" 
plugboard = "AJ BW CN DQ EL FH GM IP KS OZ RY TX UV"
...
def encode(plaintext):
  ...
  #Convert plugboard into a dictionary
...
print("  ##### Anubis' Enigma Encoder #####")
print("")
plaintext = input("Enter secrets to encode or decode:\n")
